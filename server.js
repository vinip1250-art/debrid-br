...
const STREMTHRU_HOST = "https://stremthrufortheweebs.midnightignite.me"; // Host Atualizado
  ...
  "presets": [
    {
      ...
      "options": {
        ...
        "url": "https://stremthru.atbphosting.com/stremio/torz/configure"
      }
    },
    {
      "type": "torbox-search",
            ...
            <div class="space-y-6">
                ...
                <div class="bg-[#1a1a1a] p-4 rounded-xl border border-gray-800">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <p class="text-xs text-center text-green-400 mt-1">Ganhe 7 dias/mês ou 84 dias/ano assinados: <span id="tb_ref_code" class="font-mono text-xs cursor-pointer select-all underline" onclick="copyRefCode('${REFERRAL_TB}')">Copiar Código</span></p>
                    </div>
                </div>
